...
class DomImprovedSafe extends Dom
{
    ...
    $force = false
        ...
        // 🔥 limpeza (mantendo padrão do seu projeto)
        ...
        if ($obrigatorio || $content !== '' || $force) {
            ...
            // 👇 AQUI resolve TODOS os problemas de XML
            $temp->appendChild(
...
use DOMException;
use DOMNode;
//use NFePHP\Common\DOMImproved as Dom; //linha Original
use stdClass;
...
class Dps implements DpsInterface
{
    ...
    {
        $this->init($std);
        //$this->dom = new Dom('1.0', 'UTF-8'); //linha original de nfse lib
        $this->dom = new DomImprovedSafe('1.0', 'UTF-8');
