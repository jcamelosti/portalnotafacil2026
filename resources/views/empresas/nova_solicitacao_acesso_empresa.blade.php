<x-area-cliente-layout title="Adicionar Empresa">
    ...
    <div class="py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg py-1">
            <h1 class="px-4 py-3">
                Adicionar Empresa Compartilhada entre Contas
                <p class="mt-1 max-w-2xl text-sm text-gray-500">
                    Gerenciamento de Empresas Compartilhadas
                </p>
            </h1>
        ...
        <div class="container grid mx-auto py-10 max-w-10xl">
            {!! Form::open(['route'=>'empresas.gravar-solicitar-acesso-empresa']) !!}
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md ">
                <label class="block text-sm">
                    ...
                    :shadow-outline-gray form-input', 'placeholder'=>'CNPJ da Empresa que deseja acesso Compartilhado', 'id' => 'cpf_cnpj']) !!}
