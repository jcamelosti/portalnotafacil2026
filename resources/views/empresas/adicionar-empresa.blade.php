<x-area-cliente-layout title="Empresa">
    <x-slot name="header">
    ...
    <div class="py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg py-1">
            ...
            <div class="px-4 py-3 mb-8 bg-white ">
                {!! Form::open(['route'=>'empresas.adicionar', 'method'=>'POST']) !!}
                <label class="block text-sm">
                    <span class="text-gray-700 ">Informe o CNPJ da Empresa a ser Cadastrada:</span>
