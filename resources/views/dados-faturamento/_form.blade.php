...
<div class="w-full px-4 py-3 mb-8 bg-white rounded-lg shadow-md ">
    <label class="block text-sm">
        ...
        {!! Form::text('cpf_cnpj', $cliente->cpf_cnpj_fmt, [
            ...
            'onpaste'=>"return true;",
            'maxlength'=>18,
            'required','class'=>'block w-60 mt-1 text-sm  
    ...
    <label class="block text-sm">
        <span class="text-gray-700 ">Nome Completo/Razão Social:</span>
        {!! Form::text('razao_social', !empty($cliente->razao_social) ? $cliente->razao_social : '', ['maxlength' => '255', 'required', 'class'=>'block w-full mt-1 text-sm  
        focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
    ...
    <div class="grid grid-cols-2 gap-1">
        <label class="block text-sm">
            ...
            {!! Form::text('telefone1', !empty($cliente->telefone1) ? $cliente->telefone1 : '', ['required','class'=>'block w-full mt-1 text-sm 
        ...
        <label class="block text-sm">
            ...
            {!! Form::text('telefone2', !empty($cliente->telefone2) ? $cliente->telefone2 : '', ['class'=>'block w-full mt-1 text-sm  
            focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
    ...
    <div class="grid grid-cols-2 gap-1">
        <label class="block text-sm">
            ...
            {!! Form::text('cep', !empty($cliente->cep) ? $cliente->cep : '', ['required','class'=>'cep block w-full mt-1 text-sm  
            focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
    ...
    <div class="grid grid-cols-2 gap-1">
        <label class="block text-sm">
            ...
            {!! Form::text('endereco', !empty($cliente->endereco) ? $cliente->endereco : '', ['required','class'=>'block w-full mt-1 text-sm  
            focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
        ...
        <label class="block text-sm">
            ...
            {!! Form::text('numero', !empty($cliente->numero) ? $cliente->numero : ' ', ['maxlength' => '6','class'=>'block w-full mt-1 text-sm  
            focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
    ...
    <div class="grid grid-cols-1 gap-1">
        <label class="block text-sm">
            ...
            {!! Form::text('complemento', !empty($cliente->complemento) ? $cliente->complemento : '', ['maxlength' => '255','class'=>'block w-full mt-1 text-sm 
    ...
    <div class="grid grid-cols-4 gap-1">
        <label class="block text-sm">
            ...
            {!! Form::text('bairro', !empty($cliente->bairro) ? $cliente->bairro : '', ['maxlength' => '255','required','class'=>'block w-full mt-1 text-sm  
            focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
        ...
        <div id="containerCidade">
            <label class="block text-sm w-10/12" id="cidade_id">
                ...
                {!! Form::select('cidade_id', $cidades, $cliente->cidade_id, ['maxlength' => '255','required','class'=>'block w-full mt-1 text-sm  
                focus:border-purple-400 focus:outline-none focus:shadow-outline-purple 
